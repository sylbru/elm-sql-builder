// elm-watch hot {"version":"1.0.2","webSocketPort":38809}
"use strict";
(() => {
...
${variant}`;
  ...
  var VERSION = "1.0.2";
  var TARGET_NAME = "elm-sql-builder";
  var INITIAL_ELM_COMPILED_TIMESTAMP = Number(
    "1665262387049"
  );
  var ORIGINAL_COMPILATION_MODE = "standard";
  var WEBSOCKET_PORT = "38809";
...
var $author$project$SqlBuilder$build = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				'SELECT',
				A2($elm$core$String$join, ', ', select),
				'FROM',
				from
			]));
};
...
var $author$project$Main$sqlQuery = {
	from: 't',
	select: _List_fromArray(
		['f1', 'f2'])
};
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('query')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$SqlBuilder$build($author$project$Main$sqlQuery))
			]));
};
